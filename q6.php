    ...
    <body onload =  "configure();">        
        <div class="box" class="warp">
            <form class="myForm" action="" method="post" autocomplete="off" checked="false">
                <div class="inputBox">
                    <p>6. Saya lebih senang bermain gadget daripada bercengkrama bersama keluarga atau teman.</p>
                    <div class="jawab">
                            <input type="hidden" name="number" value="nomer 6">
