...
<html lang="en" dir="ltr">
    ...
    <body>           
        <div class="box" class="warp">
            <form class="myForm" action="" method="post" autocomplete="no">
                <div class="inputBox">
                    <p>9. saya merasa bahwa diri saya saat ini telah kecanduan terhadap gadget.</p>
                    <div class="jawab">
                        <input type="hidden" name="number6" value="nomer9">
                    ...
                    <div class="tombol">
                        <!--a href="q8.php"><input type="button" id="back" action="href" value="<Back<"></a-->
