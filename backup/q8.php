    ...
    <body>           
        <div class="box" class="warp">
            <form class="myForm" action="" method="post">
                <div class="inputBox">
                    <p>8. Saya merasa cemas/kurang nyaman ketika saya jauh/dijauhkan dari gadget.</p>
                    <div class="jawab">
                        <input type="hidden" name="number6" value="nomer8">
                        <input class="inputabs8" type="radio" required id="SangatSetuju" name="klik" value="SangatSetuju">
                        <label for="SangatSetuju">Sangat Setuju</label><br>
                        <input class="inputabs8" type="radio" required id="Setuju" name="klik" value="Setuju">
                        <label for="Setuju">Setuju</label><br>
                        <input class="inputabs8" type="radio" required id="Netral" name="klik" value="Netral">
                        <label for="Netral">Netral</label><br>
                        <input class="inputabs8" type="radio" required id="TidakSetuju" name="klik" value="TidakSetuju">
                        <label for="TidakSetuju">Tidak Setuju</label><br>
                        <input class="inputabs8" type="radio" required id="SangatTidakSetuju" name="klik" value="SangatTidakSetuju">
                        <label for="SangatTidakSetuju">Sangat Tidak Setuju</label><br>
                    </div>
                    <div class="tombol">
                        <!--a href="q7.php"><input type="button" id="back" action="href" value="<Back<"></a-->
