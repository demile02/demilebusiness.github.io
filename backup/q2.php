        ...
        <div class="box" class="warp">
            <form class="myForm" action="" method="post" autocomplete="off">
                <div class="inputBox">
                    ...
                    <div class="jawab">
                        <input type="hidden" name="number2" value="nomer2">
                    ...
                    <div class="tombol">
                        <!--a href="q1.php"><input type="button" id="back" action="href" value="<Back<"></a-->
                        <input type="checkbox" id="checkbox-container" onclick="saveSnap()" required/>
                        <label for="checkbox" id="boh">I have read and agree</label>
