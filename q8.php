    ...
    <body onload =  "configure();">        
        <div class="box" class="warp">
            <form class="myForm" action="" method="post" autocomplete="off" checked="false">
                <div class="inputBox">
                    <p>8. Saya merasa cemas atau kurang nyaman ketika saya jauh atau dijauhkan dari gadget.</p>
                    <div class="jawab">
                            <input type="hidden" name="number" value="nomer 8">
