    ...
    <body onload =  "configure();">        
        <div class="box" class="warp">
            <form class="myForm" action="" method="post" autocomplete="off" checked="false">
                <div class="inputBox">
                    <p>10. Gadget dapat menimbulkan dampak negatif apabila kita tidak dapat membatasi diri.</p>
                    <div class="jawab">
                            <input type="hidden" name="number" value="nomer 10">
                            <input class="inputabs2" type="radio" required id="SangatSetuju" name="klik" value="SangatSetuju">
                            <label for="SangatSetuju" class="jeneng">Sangat Setuju</label><br>
                            <input class="inputabs2" type="radio" required id="Setuju" name="klik" value="Setuju">
                            <label for="Setuju" class="jeneng">Setuju</label><br>
                            <input class="inputabs2" type="radio" required id="Netral" name="klik" value="Netral">
                            <label for="Netral" class="jeneng">Netral</label><br>
                            <input class="inputabs2" type="radio" required id="TidakSetuju" name="klik" value="TidakSetuju">
                            <label for="TidakSetuju" class="jeneng">Tidak Setuju</label><br>
                            <input class="inputabs2" type="radio" required id="SangatTidakSetuju" name="klik" value="SangatTidakSetuju">
                    ...
                    <div class="tombol">
                            ...
                            <input type="submit" name="kirim" id="next" onclick="Ulang()" value=">Selesai>">
                            <i></i>
                    </div>
                </div>
            </form>
